...
export default function Create() {
  ...
  const generateMutation = useMutation({
    mutationFn: async () => {
      ...
      const prompt = `Transform the provided photo of this ${breed} ${speciesLabel} named "${safeName}" into the following artistic style. Keep the ${speciesLabel}'s actual appearance, markings, colors, and features recognizable.${realismNote} Style: ${selectedStyle!.promptTemplate.replace("{breed}", breed)}`;
